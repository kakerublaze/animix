class GetTrendingAnimeResponseModel {
  int? currentPage;
  bool? hasNextPage;
  List<TrendingAnime>? trendingAnimes;

  GetTrendingAnimeResponseModel({
    this.currentPage,
    this.hasNextPage,
    this.trendingAnimes,
  });

  GetTrendingAnimeResponseModel.fromJson(Map<String, dynamic> json) {
    currentPage = json['currentPage'];
    hasNextPage = json['hasNextPage'];
    if (json['results'] != null) {
      trendingAnimes = <TrendingAnime>[];
      json['results'].forEach((v) {
        trendingAnimes!.add(TrendingAnime.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (trendingAnimes != null) {
      data['results'] = trendingAnimes!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
